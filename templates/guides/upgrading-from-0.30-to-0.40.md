...
### 1. `seqera_aws_compute_env` → `seqera_aws_batch_ce` (recommended, optional)
...
### 2. Azure Batch `delete_jobs_on_completion` → `delete_jobs_on_completion_enabled`
...
### 3. EBS auto-scale fields are deprecated
