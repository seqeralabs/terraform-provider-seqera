...
#   value       = seqera_orgs.test_org.org_id
# }
...
#   value       = seqera_pipeline_secret.my_pipelinesecret.pipeline_secret_id
# }
...
#   value       = seqera_studios.my_datastudios.id
# }

# # output "label_id" {
# #   description = "ID of the created label"
# #   value       = seqera_labels.my_labels.id
# # }