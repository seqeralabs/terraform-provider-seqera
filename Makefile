...
format-spec: ## Sort OpenAPI spec for clean diffs
	npx openapi-format specs/seqera-api-cloud.yaml -o specs/seqera-api-cloud.yaml --sortComponentsProps -s specs/.openapi-format-sort.yaml --yamlQuoteStyle single
