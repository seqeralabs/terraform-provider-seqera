...
func (s *Launch) DescribeLaunch(ctx context.Context, request operations.DescribeLaunchRequest, opts ...operations.Option) (*operations.DescribeLaunchResponse, error) {
