...
func newLaunch(rootSDK *Seqera, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Launch {
	return &Launch{
		rootSDK:          rootSDK,
...
// Get - Describe Launch record
// Retrieves the details of the launch identified by the given `launchId`.
func (s *Launch) Get(ctx context.Context, request operations.DescribeLaunchRequest, opts ...operations.Option) (*operations.DescribeLaunchResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/launch/{launchId}", request, nil)
	if err != nil {
	...
	res := &operations.DescribeLaunchResponse{
...
// ListDatasets - Describe launch datasets
// Retrieves the details of the datasets used in the launch identified by the given `launchId`.
func (s *Launch) ListDatasets(ctx context.Context, request operations.ListLaunchDatasetVersionsRequest, opts ...operations.Option) (*operations.ListLaunchDatasetVersionsResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionTimeout,
	}
