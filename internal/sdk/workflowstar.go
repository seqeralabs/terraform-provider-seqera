...
func (s *WorkflowStar) Star(ctx context.Context, request operations.CreateWorkflowStarRequest, opts ...operations.Option) (*operations.CreateWorkflowStarResponse, error) {
...
func (s *WorkflowStar) Unstar(ctx context.Context, request operations.DeleteWorkflowStarRequest, opts ...operations.Option) (*operations.DeleteWorkflowStarResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionTimeout,
	}
