...
func newRegions(rootSDK *Seqera, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Regions {
	return &Regions{
		rootSDK:          rootSDK,
...
func (s *Regions) List(ctx context.Context, request operations.ListPlatformRegionsRequest, opts ...operations.Option) (*operations.ListPlatformRegionsResponse, error) {
