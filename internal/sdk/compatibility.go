...
func newCompatibility(rootSDK *Seqera, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Compatibility {
...
func (s *Compatibility) CatalogComponentVersions(ctx context.Context, request operations.CatalogComponentVersionsRequest, opts ...operations.Option) (*operations.CatalogComponentVersionsResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/catalog/components/{key}/versions", request, nil)
	if err != nil {
	...
	hookCtx := hooks.HookContext{
		...
		BaseURL:          baseURL,
		Context:          ctx,
		OperationID:      "CatalogComponentVersions",
		OAuth2Scopes:     nil,
	...
	res := &operations.CatalogComponentVersionsResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.CatalogVersionsResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.CatalogVersionsResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *Compatibility) CatalogVersions(ctx context.Context, request operations.CatalogVersionsRequest, opts ...operations.Option) (*operations.CatalogVersionsResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/catalog/versions")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.CatalogVersionsResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
