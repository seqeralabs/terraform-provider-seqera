...
func newTemplates(rootSDK *Seqera, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Templates {
	return &Templates{
		rootSDK:          rootSDK,
...
func (s *Templates) List(ctx context.Context, request operations.ListDataStudioTemplatesRequest, opts ...operations.Option) (*operations.ListDataStudioTemplatesResponse, error) {
