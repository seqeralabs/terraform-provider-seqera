...
func newCheckpoints(rootSDK *Seqera, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Checkpoints {
	return &Checkpoints{
		rootSDK:          rootSDK,
...
func (s *Checkpoints) Get(ctx context.Context, request operations.GetDataStudioCheckpointRequest, opts ...operations.Option) (*operations.GetDataStudioCheckpointResponse, error) {
