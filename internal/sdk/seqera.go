...
// Generated from OpenAPI doc version 1.45.0 and generator version 2.664.0
...
func New(opts ...SDKOption) *Seqera {
	sdk := &Seqera{
		SDKVersion: "0.0.3",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/terraform 0.0.3 2.664.0 1.45.0 github.com/speakeasy/terraform-provider-seqera/internal/sdk",
