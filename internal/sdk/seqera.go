...
// Generated from OpenAPI doc version 1.153.0 and generator version 2.886.1
...
func New(opts ...SDKOption) *Seqera {
	sdk := &Seqera{
		...
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/terraform 0.40.0-RC8 2.886.1 1.153.0 github.com/seqeralabs/terraform-provider-seqera/internal/sdk",
