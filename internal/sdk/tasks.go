...
func newTasks(rootSDK *Seqera, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Tasks {
	return &Tasks{
		rootSDK:          rootSDK,
...
// Get - Describe a task entity with the given ID
func (s *Tasks) Get(ctx context.Context, request operations.DescribeWorkflowTaskRequest, opts ...operations.Option) (*operations.DescribeWorkflowTaskResponse, error) {
