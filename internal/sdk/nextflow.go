...
func newNextflow(rootSDK *Seqera, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Nextflow {
	return &Nextflow{
		rootSDK:          rootSDK,
...
// NextflowVersions - Nextflow version catalog
...
func (s *Nextflow) NextflowVersions(ctx context.Context, opts ...operations.Option) (*operations.NextflowVersionsResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/platform/versions")
	if err != nil {
	...
	res := &operations.NextflowVersionsResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.NextflowVersionsResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.NextflowVersionsResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
