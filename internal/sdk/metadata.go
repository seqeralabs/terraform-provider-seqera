...
func newMetadata(rootSDK *Seqera, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Metadata {
	return &Metadata{
		rootSDK:          rootSDK,
...
func (s *Metadata) Get(ctx context.Context, request operations.DescribeDatasetV2Request, opts ...operations.Option) (*operations.DescribeDatasetV2Response, error) {
