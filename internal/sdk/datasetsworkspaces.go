...
type DatasetsWorkspaces struct {
	rootSDK          *Seqera
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newDatasetsWorkspaces(rootSDK *Seqera, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *DatasetsWorkspaces {
	return &DatasetsWorkspaces{
		rootSDK:          rootSDK,
...
// ListVersions - List latest dataset versions
// Lists the latest version of each dataset associated with the given `workspaceId`.
//
// Deprecated: This will be removed in a future release, please migrate away from it as soon as possible.
func (s *DatasetsWorkspaces) ListVersions(ctx context.Context, request operations.ListWorkspaceDatasetVersionsRequest, opts ...operations.Option) (*operations.ListWorkspaceDatasetVersionsResponse, error) {
