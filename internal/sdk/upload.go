...
func newUpload(rootSDK *Seqera, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Upload {
	return &Upload{
		rootSDK:          rootSDK,
...
// GenerateURL - Generate file upload URL
...
func (s *Upload) GenerateURL(ctx context.Context, request operations.GenerateDataLinkUploadURLRequest, opts ...operations.Option) (*operations.GenerateDataLinkUploadURLResponse, error) {
