...
type DeleteAwsCloudCERequest struct {
...
func (d *DeleteAwsCloudCERequest) GetComputeEnvID() string {
	if d == nil {
		return ""
	}
...
func (d *DeleteAwsCloudCERequest) GetWorkspaceID() int64 {
	if d == nil {
		return 0
	}
...
func (d *DeleteAwsCloudCERequest) GetForce() *bool {
	if d == nil {
		return nil
	}
	return d.Force
...
type DeleteAwsCloudCEResponse struct {
...
func (d *DeleteAwsCloudCEResponse) GetContentType() string {
	if d == nil {
		return ""
	}
...
func (d *DeleteAwsCloudCEResponse) GetStatusCode() int {
	if d == nil {
		return 0
	}
	return d.StatusCode
...
func (d *DeleteAwsCloudCEResponse) GetRawResponse() *http.Response {
	if d == nil {
		return nil
	}
...
func (d *DeleteAwsCloudCEResponse) GetErrorResponse() *shared.ErrorResponse {
	if d == nil {
		return nil
	}
