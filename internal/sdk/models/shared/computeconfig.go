...
type ComputeConfig struct {
	AWSBatchConfiguration           *AWSBatchConfiguration           `queryParam:"inline,name=ComputeConfig" union:"member"`
	AWSCloudConfiguration           *AWSCloudConfiguration           `queryParam:"inline,name=ComputeConfig" union:"member"`
	SeqeraComputeConfiguration      *SeqeraComputeConfiguration      `queryParam:"inline,name=ComputeConfig" union:"member"`
	GoogleLifeSciencesConfiguration *GoogleLifeSciencesConfiguration `queryParam:"inline,name=ComputeConfig" union:"member"`
	GoogleBatchServiceConfiguration *GoogleBatchServiceConfiguration `queryParam:"inline,name=ComputeConfig" union:"member"`
	AzureBatchConfiguration         *AzureBatchConfiguration         `queryParam:"inline,name=ComputeConfig" union:"member"`
	IBMLSFConfiguration             *IBMLSFConfiguration             `queryParam:"inline,name=ComputeConfig" union:"member"`
	SlurmConfiguration              *SlurmConfiguration              `queryParam:"inline,name=ComputeConfig" union:"member"`
	KubernetesComputeConfiguration  *KubernetesComputeConfiguration  `queryParam:"inline,name=ComputeConfig" union:"member"`
	AmazonEKSClusterConfiguration   *AmazonEKSClusterConfiguration   `queryParam:"inline,name=ComputeConfig" union:"member"`
	GoogleGKEClusterConfiguration   *GoogleGKEClusterConfiguration   `queryParam:"inline,name=ComputeConfig" union:"member"`
	UnivaGridEngineConfiguration    *UnivaGridEngineConfiguration    `queryParam:"inline,name=ComputeConfig" union:"member"`
	AltairPBSConfiguration          *AltairPBSConfiguration          `queryParam:"inline,name=ComputeConfig" union:"member"`
	MoabConfiguration               *MoabConfiguration               `queryParam:"inline,name=ComputeConfig" union:"member"`
