...
// DescribeWorkflowResponseBackendStrategy - Backend used by Intelligent Compute to run tasks. 'ECS' (default) delegates task execution to AWS ECS; 'EC2' runs tasks directly on AWS EC2 instances.
...
func (d *DescribeWorkflowResponseSchedConfig) GetPool() *SchedConfigPool {
	if d == nil {
		return nil
	}
	return d.Pool
