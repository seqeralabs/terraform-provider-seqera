...
func newServiceInfo(rootSDK *Seqera, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *ServiceInfo {
	return &ServiceInfo{
		rootSDK:          rootSDK,
...
// Info - General Seqera service features and version.
func (s *ServiceInfo) Info(ctx context.Context, opts ...operations.Option) (*operations.InfoResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/service-info")
	if err != nil {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.ServiceInfoResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.ServiceInfoResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
