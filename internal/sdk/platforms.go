...
func newPlatforms(rootSDK *Seqera, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Platforms {
	return &Platforms{
		...
		hooks:            hooks,
		Regions:          newRegions(rootSDK, sdkConfig, hooks),
	}
}

// List platforms
// Lists all available computing platforms in a user context. Append `?workspaceId` to list platforms in a workspace context.
func (s *Platforms) List(ctx context.Context, request operations.ListPlatformsRequest, opts ...operations.Option) (*operations.ListPlatformsResponse, error) {
...
func (s *Platforms) Get(ctx context.Context, request operations.DescribePlatformRequest, opts ...operations.Option) (*operations.DescribePlatformResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionTimeout,
	}
