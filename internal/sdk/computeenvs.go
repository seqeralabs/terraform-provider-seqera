...
// CreateAWSBatchComputeEnv - Create AWS Batch compute environment (v2)
// Creates a new AWS Batch compute environment with hoisted configuration. Append `?workspaceId` to create the environment in a workspace context.
func (s *ComputeEnvs) CreateAWSBatchComputeEnv(ctx context.Context, request operations.CreateAWSBatchComputeEnvRequest, opts ...operations.Option) (*operations.CreateAWSBatchComputeEnvResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionTimeout,
	}
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "CreateAWSBatchComputeEnvRequest", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
	...
	res := &operations.CreateAWSBatchComputeEnvResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.CreateAWSBatchComputeEnvResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.CreateAWSBatchComputeEnvResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
// DescribeAWSBatchComputeEnv - Describe AWS Batch compute environment (v2)
// Retrieves the details of the AWS Batch compute environment identified by the given `computeEnvId`.
func (s *ComputeEnvs) DescribeAWSBatchComputeEnv(ctx context.Context, request operations.DescribeAWSBatchComputeEnvRequest, opts ...operations.Option) (*operations.DescribeAWSBatchComputeEnvResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionTimeout,
	}
	...
	res := &operations.DescribeAWSBatchComputeEnvResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.DescribeAWSBatchComputeEnvResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.DescribeAWSBatchComputeEnvResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
// UpdateAWSBatchComputeEnv - Update AWS Batch compute environment (v2)
// Updates the details of the AWS Batch compute environment identified by the given `computeEnvId`.
func (s *ComputeEnvs) UpdateAWSBatchComputeEnv(ctx context.Context, request operations.UpdateAWSBatchComputeEnvRequest, opts ...operations.Option) (*operations.UpdateAWSBatchComputeEnvResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionTimeout,
	}
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "UpdateAWSBatchComputeEnvRequest", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
	...
	res := &operations.UpdateAWSBatchComputeEnvResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
// DeleteAWSBatchComputeEnv - Delete AWS Batch compute environment (v2)
// Deletes the AWS Batch compute environment identified by the given `computeEnvId`.
func (s *ComputeEnvs) DeleteAWSBatchComputeEnv(ctx context.Context, request operations.DeleteAWSBatchComputeEnvRequest, opts ...operations.Option) (*operations.DeleteAWSBatchComputeEnvResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionTimeout,
	}
	...
	res := &operations.DeleteAWSBatchComputeEnvResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
