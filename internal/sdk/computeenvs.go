...
// CreateGoogleBatchCE - Create Google Batch compute environment
// Creates a new Google Batch compute environment. Append `?workspaceId` to create the environment in a workspace context.
func (s *ComputeEnvs) CreateGoogleBatchCE(ctx context.Context, request operations.CreateGoogleBatchCERequest, opts ...operations.Option) (*operations.CreateGoogleBatchCEResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "CreateGoogleBatchCERequest", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
	...
	res := &operations.CreateGoogleBatchCEResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.CreateGoogleBatchCEResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.CreateGoogleBatchCEResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
// DescribeGoogleBatchCE - Describe Google Batch compute environment
// Retrieves the details of the Google Batch compute environment identified by the given `computeEnvId`.
func (s *ComputeEnvs) DescribeGoogleBatchCE(ctx context.Context, request operations.DescribeGoogleBatchCERequest, opts ...operations.Option) (*operations.DescribeGoogleBatchCEResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionTimeout,
	}
	...
	res := &operations.DescribeGoogleBatchCEResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.DescribeGoogleBatchCEResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.DescribeGoogleBatchCEResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
// DeleteGoogleBatchCE - Delete Google Batch compute environment
// Deletes the Google Batch compute environment identified by the given `computeEnvId`.
func (s *ComputeEnvs) DeleteGoogleBatchCE(ctx context.Context, request operations.DeleteGoogleBatchCERequest, opts ...operations.Option) (*operations.DeleteGoogleBatchCEResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionTimeout,
	}
	...
	res := &operations.DeleteGoogleBatchCEResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
