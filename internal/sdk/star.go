...
func newStar(rootSDK *Seqera, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Star {
	return &Star{
		rootSDK:          rootSDK,
...
// Describe - Check workflow star status
// Confirms whether the given `workflowId` is starred.
func (s *Star) Describe(ctx context.Context, request operations.DescribeWorkflowStarRequest, opts ...operations.Option) (*operations.DescribeWorkflowStarResponse, error) {
