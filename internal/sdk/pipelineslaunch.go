...
type PipelinesLaunch struct {
	rootSDK          *Seqera
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newPipelinesLaunch(rootSDK *Seqera, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *PipelinesLaunch {
	return &PipelinesLaunch{
		rootSDK:          rootSDK,
...
// Get - Describe pipeline launch
// Retrieves the launch details of the pipeline identified by the given `pipelineId`.
func (s *PipelinesLaunch) Get(ctx context.Context, request operations.DescribePipelineLaunchRequest, opts ...operations.Option) (*operations.DescribePipelineLaunchResponse, error) {
