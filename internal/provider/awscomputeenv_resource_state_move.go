// This file implements ResourceWithMoveState for AWSComputeEnvResource
// to allow migration from compatible compute environment resources to
// seqera_aws_compute_env without destroying and recreating the resource.
//
// This is a sidecar file that adds the MoveState method to the generated
// AWSComputeEnvResource type. Speakeasy does not manage this file.
//
...
//	  to   = seqera_aws_compute_env.example
//	}
//
//	moved {
//	  from = seqera_aws_batch_ce.example
//	  to   = seqera_aws_compute_env.example
//	}
...
var _ resource.ResourceWithMoveState = &AWSComputeEnvResource{}

// MoveState returns the state movers for migrating from other resource types
func (r *AWSComputeEnvResource) MoveState(ctx context.Context) []resource.StateMover {
	return []resource.StateMover{
		{
			// Allow migration from seqera_compute_env to seqera_aws_compute_env
			...
			StateMover: func(ctx context.Context, req resource.MoveStateRequest, resp *resource.MoveStateResponse) {
				...
				tflog.Debug(ctx, "Processing state move request", map[string]interface{}{
					...
					"target_type":     "seqera_aws_compute_env",
				})
				...
				tflog.Info(ctx, "Successfully moved state to seqera_aws_compute_env", map[string]interface{}{
					"source_type": req.SourceTypeName,
				})
			},
		},
