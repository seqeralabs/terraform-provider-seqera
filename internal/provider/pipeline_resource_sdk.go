...
func (r *PipelineResourceModel) RefreshFromSharedDescribeLaunchResponse(ctx context.Context, resp *shared.DescribeLaunchResponse) diag.Diagnostics {
	var diags diag.Diagnostics
...
func (r *PipelineResourceModel) ToOperationsDescribePipelineLaunchRequest(ctx context.Context) (*operations.DescribePipelineLaunchRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	out := operations.DescribePipelineLaunchRequest{
		PipelineID:  pipelineID,
		WorkspaceID: workspaceID,
	}
