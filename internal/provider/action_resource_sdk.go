		...
		if resp.Launch != nil {
			...
			if resp.Launch.ComputeEnv == nil {
				...
				if resp.Launch.ComputeEnv.Config.GoogleCloudConfiguration != nil {
					...
					for _, environmentItem5 := range resp.Launch.ComputeEnv.Config.GoogleCloudConfiguration.Environment {
					...
					for _, forgedResourcesItem := range resp.Launch.ComputeEnv.Config.GoogleCloudConfiguration.ForgedResources {
				...
				if resp.Launch.ComputeEnv.Config.AzureBatchConfiguration != nil {
					...
					for _, environmentItem6 := range resp.Launch.ComputeEnv.Config.AzureBatchConfiguration.Environment {
				...
				if resp.Launch.ComputeEnv.Config.AzureCloudConfiguration != nil {
					...
					for _, environmentItem7 := range resp.Launch.ComputeEnv.Config.AzureCloudConfiguration.Environment {
					...
					for _, forgedResourcesItem1 := range resp.Launch.ComputeEnv.Config.AzureCloudConfiguration.ForgedResources {
				...
				if resp.Launch.ComputeEnv.Config.SlurmConfiguration != nil {
					...
					for _, environmentItem9 := range resp.Launch.ComputeEnv.Config.SlurmConfiguration.Environment {
				...
				if resp.Launch.ComputeEnv.Config.KubernetesComputeConfiguration != nil {
					...
					for _, environmentItem10 := range resp.Launch.ComputeEnv.Config.KubernetesComputeConfiguration.Environment {
				...
				if resp.Launch.ComputeEnv.Config.AmazonEKSClusterConfiguration != nil {
					...
					for _, environmentItem11 := range resp.Launch.ComputeEnv.Config.AmazonEKSClusterConfiguration.Environment {
				...
				if resp.Launch.ComputeEnv.Config.GoogleGKEClusterConfiguration != nil {
					...
					for _, environmentItem12 := range resp.Launch.ComputeEnv.Config.GoogleGKEClusterConfiguration.Environment {
				...
				if resp.Launch.ComputeEnv.Config.AltairPBSConfiguration != nil {
					...
					for _, environmentItem14 := range resp.Launch.ComputeEnv.Config.AltairPBSConfiguration.Environment {
				...
				if resp.Launch.ComputeEnv.Config.MoabConfiguration != nil {
					...
					for _, environmentItem15 := range resp.Launch.ComputeEnv.Config.MoabConfiguration.Environment {
				...
				if resp.Launch.ComputeEnv.Config.LocalExecutionConfiguration != nil {
					...
					for _, environmentItem16 := range resp.Launch.ComputeEnv.Config.LocalExecutionConfiguration.Environment {
