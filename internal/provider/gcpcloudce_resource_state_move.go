// This file implements ResourceWithMoveState for GCPCloudCEResource
// to allow migration from compatible compute environment resources to
// seqera_gcp_cloud_ce without destroying and recreating the resource.
//
// This is a sidecar file that adds the MoveState method to the generated
// GCPCloudCEResource type. Speakeasy does not manage this file.
//
...
//	  to   = seqera_gcp_cloud_ce.example
//	}
...
var _ resource.ResourceWithMoveState = &GCPCloudCEResource{}

// MoveState returns the state movers for migrating from other resource types
func (r *GCPCloudCEResource) MoveState(ctx context.Context) []resource.StateMover {
	return []resource.StateMover{
		{
			// Allow migration from seqera_compute_env to seqera_gcp_cloud_ce.
			...
			StateMover: func(ctx context.Context, req resource.MoveStateRequest, resp *resource.MoveStateResponse) {
				tflog.Debug(ctx, "Processing state move request", map[string]interface{}{
					...
					"target_type":     "seqera_gcp_cloud_ce",
				})
				...
				tflog.Info(ctx, "Successfully moved state to seqera_gcp_cloud_ce", map[string]interface{}{
					"source_type": req.SourceTypeName,
				})
			},
		},
