...
var _ datasource.DataSource = &AWSBatchCEDataSource{}
var _ datasource.DataSourceWithConfigure = &AWSBatchCEDataSource{}

func NewAWSBatchCEDataSource() datasource.DataSource {
	return &AWSBatchCEDataSource{}
}

// AWSBatchCEDataSource is the data source implementation.
type AWSBatchCEDataSource struct {
	// Provider configured SDK client.
	client *sdk.Seqera
}

// AWSBatchCEDataSourceModel describes the data model.
type AWSBatchCEDataSourceModel struct {
...
func (r *AWSBatchCEDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_aws_batch_ce"
}

// Schema defines the schema for the data source.
func (r *AWSBatchCEDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (r *AWSBatchCEDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *AWSBatchCEDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *AWSBatchCEDataSourceModel
