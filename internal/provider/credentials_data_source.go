...
type CredentialsDataSourceModel struct {
	Credentials []tfTypes.Credential `tfsdk:"credentials"`
...
func (r *CredentialsDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	if !(res.ListCredentialsDataSourceResponse != nil) {
		resp.Diagnostics.AddError("unexpected response from API. Got an unexpected response body", debugResponse(res.RawResponse))
		return
	}
	resp.Diagnostics.Append(data.RefreshFromSharedListCredentialsDataSourceResponse(ctx, res.ListCredentialsDataSourceResponse)...)
