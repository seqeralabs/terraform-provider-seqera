...
func (r *PipelineSecretDataSourceModel) RefreshFromSharedDescribePipelineSecretResponse(ctx context.Context, resp *shared.DescribePipelineSecretResponse) diag.Diagnostics {
