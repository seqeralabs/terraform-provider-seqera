// This file implements ResourceWithMoveState for AzureBatchCEResource
// to allow migration from compatible compute environment resources to
// seqera_azure_batch_ce without destroying and recreating the resource.
//
// This is a sidecar file that adds the MoveState method to the generated
// AzureBatchCEResource type. Speakeasy does not manage this file.
//
...
//	  to   = seqera_azure_batch_ce.example
//	}
...
var _ resource.ResourceWithMoveState = &AzureBatchCEResource{}

// MoveState returns the state movers for migrating from other resource types
func (r *AzureBatchCEResource) MoveState(ctx context.Context) []resource.StateMover {
	return []resource.StateMover{
		{
			// Allow migration from seqera_compute_env to seqera_azure_batch_ce.
			...
			StateMover: func(ctx context.Context, req resource.MoveStateRequest, resp *resource.MoveStateResponse) {
				tflog.Debug(ctx, "Processing state move request", map[string]interface{}{
					...
					"target_type":     "seqera_azure_batch_ce",
				})
				...
				tflog.Info(ctx, "Successfully moved state to seqera_azure_batch_ce", map[string]interface{}{
					"source_type": req.SourceTypeName,
				})
			},
		},
