		...
		if resp.Launch == nil {
			...
			if resp.Launch.ComputeEnv == nil {
				...
				if resp.Launch.ComputeEnv.Config.AltairPBSConfiguration != nil {
					...
					for environmentCount, environmentItem := range resp.Launch.ComputeEnv.Config.AltairPBSConfiguration.Environment {
						...
						if environmentCount+1 > len(r.Launch.ComputeEnv.Config.AltairPlatform.Environment) {
							...
							r.Launch.ComputeEnv.Config.AltairPlatform.Environment[environmentCount].Compute = environment.Compute
							r.Launch.ComputeEnv.Config.AltairPlatform.Environment[environmentCount].Head = environment.Head
							r.Launch.ComputeEnv.Config.AltairPlatform.Environment[environmentCount].Name = environment.Name
							r.Launch.ComputeEnv.Config.AltairPlatform.Environment[environmentCount].Value = environment.Value
						}
					}
				...
				if resp.Launch.ComputeEnv.Config.AmazonEKSClusterConfiguration != nil {
					...
					for environmentCount1, environmentItem1 := range resp.Launch.ComputeEnv.Config.AmazonEKSClusterConfiguration.Environment {
						...
						if environmentCount1+1 > len(r.Launch.ComputeEnv.Config.EksPlatform.Environment) {
							...
							r.Launch.ComputeEnv.Config.EksPlatform.Environment[environmentCount1].Compute = environment1.Compute
							r.Launch.ComputeEnv.Config.EksPlatform.Environment[environmentCount1].Head = environment1.Head
							r.Launch.ComputeEnv.Config.EksPlatform.Environment[environmentCount1].Name = environment1.Name
							r.Launch.ComputeEnv.Config.EksPlatform.Environment[environmentCount1].Value = environment1.Value
						}
					}
				...
				if resp.Launch.ComputeEnv.Config.AWSBatchConfiguration != nil {
					...
					for environmentCount2, environmentItem2 := range resp.Launch.ComputeEnv.Config.AWSBatchConfiguration.Environment {
						...
						if environmentCount2+1 > len(r.Launch.ComputeEnv.Config.AwsBatch.Environment) {
							r.Launch.ComputeEnv.Config.AwsBatch.Environment = append(r.Launch.ComputeEnv.Config.AwsBatch.Environment, environment2)
						} else {
							r.Launch.ComputeEnv.Config.AwsBatch.Environment[environmentCount2].Compute = environment2.Compute
							r.Launch.ComputeEnv.Config.AwsBatch.Environment[environmentCount2].Head = environment2.Head
							r.Launch.ComputeEnv.Config.AwsBatch.Environment[environmentCount2].Name = environment2.Name
							r.Launch.ComputeEnv.Config.AwsBatch.Environment[environmentCount2].Value = environment2.Value
						}
					}
				...
				if resp.Launch.ComputeEnv.Config.AWSCloudConfiguration != nil {
					...
					for environmentCount3, environmentItem3 := range resp.Launch.ComputeEnv.Config.AWSCloudConfiguration.Environment {
						...
						if environmentCount3+1 > len(r.Launch.ComputeEnv.Config.AwsCloud.Environment) {
							r.Launch.ComputeEnv.Config.AwsCloud.Environment = append(r.Launch.ComputeEnv.Config.AwsCloud.Environment, environment3)
						} else {
							r.Launch.ComputeEnv.Config.AwsCloud.Environment[environmentCount3].Compute = environment3.Compute
							r.Launch.ComputeEnv.Config.AwsCloud.Environment[environmentCount3].Head = environment3.Head
							r.Launch.ComputeEnv.Config.AwsCloud.Environment[environmentCount3].Name = environment3.Name
							r.Launch.ComputeEnv.Config.AwsCloud.Environment[environmentCount3].Value = environment3.Value
						}
					}
				...
				if resp.Launch.ComputeEnv.Config.AzureBatchConfiguration != nil {
					...
					for environmentCount4, environmentItem4 := range resp.Launch.ComputeEnv.Config.AzureBatchConfiguration.Environment {
						...
						if environmentCount4+1 > len(r.Launch.ComputeEnv.Config.AzureBatch.Environment) {
							r.Launch.ComputeEnv.Config.AzureBatch.Environment = append(r.Launch.ComputeEnv.Config.AzureBatch.Environment, environment4)
						} else {
							r.Launch.ComputeEnv.Config.AzureBatch.Environment[environmentCount4].Compute = environment4.Compute
							r.Launch.ComputeEnv.Config.AzureBatch.Environment[environmentCount4].Head = environment4.Head
							r.Launch.ComputeEnv.Config.AzureBatch.Environment[environmentCount4].Name = environment4.Name
							r.Launch.ComputeEnv.Config.AzureBatch.Environment[environmentCount4].Value = environment4.Value
						}
					}
				...
				if resp.Launch.ComputeEnv.Config.GoogleBatchServiceConfiguration != nil {
					...
					for environmentCount5, environmentItem5 := range resp.Launch.ComputeEnv.Config.GoogleBatchServiceConfiguration.Environment {
						...
						if environmentCount5+1 > len(r.Launch.ComputeEnv.Config.GoogleBatch.Environment) {
							...
							r.Launch.ComputeEnv.Config.GoogleBatch.Environment[environmentCount5].Compute = environment5.Compute
							r.Launch.ComputeEnv.Config.GoogleBatch.Environment[environmentCount5].Head = environment5.Head
							r.Launch.ComputeEnv.Config.GoogleBatch.Environment[environmentCount5].Name = environment5.Name
							r.Launch.ComputeEnv.Config.GoogleBatch.Environment[environmentCount5].Value = environment5.Value
						}
					}
				...
				if resp.Launch.ComputeEnv.Config.GoogleGKEClusterConfiguration != nil {
					...
					for environmentCount6, environmentItem6 := range resp.Launch.ComputeEnv.Config.GoogleGKEClusterConfiguration.Environment {
						...
						if environmentCount6+1 > len(r.Launch.ComputeEnv.Config.GkePlatform.Environment) {
							...
							r.Launch.ComputeEnv.Config.GkePlatform.Environment[environmentCount6].Compute = environment6.Compute
							r.Launch.ComputeEnv.Config.GkePlatform.Environment[environmentCount6].Head = environment6.Head
							r.Launch.ComputeEnv.Config.GkePlatform.Environment[environmentCount6].Name = environment6.Name
							r.Launch.ComputeEnv.Config.GkePlatform.Environment[environmentCount6].Value = environment6.Value
						}
					}
				...
				if resp.Launch.ComputeEnv.Config.GoogleLifeSciencesConfiguration != nil {
					...
					for environmentCount7, environmentItem7 := range resp.Launch.ComputeEnv.Config.GoogleLifeSciencesConfiguration.Environment {
						...
						if environmentCount7+1 > len(r.Launch.ComputeEnv.Config.GoogleLifesciences.Environment) {
							...
							r.Launch.ComputeEnv.Config.GoogleLifesciences.Environment[environmentCount7].Compute = environment7.Compute
							r.Launch.ComputeEnv.Config.GoogleLifesciences.Environment[environmentCount7].Head = environment7.Head
							r.Launch.ComputeEnv.Config.GoogleLifesciences.Environment[environmentCount7].Name = environment7.Name
							r.Launch.ComputeEnv.Config.GoogleLifesciences.Environment[environmentCount7].Value = environment7.Value
						}
					}
				...
				if resp.Launch.ComputeEnv.Config.IBMLSFConfiguration != nil {
					...
					for environmentCount8, environmentItem8 := range resp.Launch.ComputeEnv.Config.IBMLSFConfiguration.Environment {
						...
						if environmentCount8+1 > len(r.Launch.ComputeEnv.Config.LsfPlatform.Environment) {
							...
							r.Launch.ComputeEnv.Config.LsfPlatform.Environment[environmentCount8].Compute = environment8.Compute
							r.Launch.ComputeEnv.Config.LsfPlatform.Environment[environmentCount8].Head = environment8.Head
							r.Launch.ComputeEnv.Config.LsfPlatform.Environment[environmentCount8].Name = environment8.Name
							r.Launch.ComputeEnv.Config.LsfPlatform.Environment[environmentCount8].Value = environment8.Value
						}
					}
				...
				if resp.Launch.ComputeEnv.Config.KubernetesComputeConfiguration != nil {
					...
					for environmentCount9, environmentItem9 := range resp.Launch.ComputeEnv.Config.KubernetesComputeConfiguration.Environment {
						...
						if environmentCount9+1 > len(r.Launch.ComputeEnv.Config.K8sPlatform.Environment) {
							...
							r.Launch.ComputeEnv.Config.K8sPlatform.Environment[environmentCount9].Compute = environment9.Compute
							r.Launch.ComputeEnv.Config.K8sPlatform.Environment[environmentCount9].Head = environment9.Head
							r.Launch.ComputeEnv.Config.K8sPlatform.Environment[environmentCount9].Name = environment9.Name
							r.Launch.ComputeEnv.Config.K8sPlatform.Environment[environmentCount9].Value = environment9.Value
						}
					}
				...
				if resp.Launch.ComputeEnv.Config.MoabConfiguration != nil {
					...
					for environmentCount10, environmentItem10 := range resp.Launch.ComputeEnv.Config.MoabConfiguration.Environment {
						...
						if environmentCount10+1 > len(r.Launch.ComputeEnv.Config.MoabPlatform.Environment) {
							...
							r.Launch.ComputeEnv.Config.MoabPlatform.Environment[environmentCount10].Compute = environment10.Compute
							r.Launch.ComputeEnv.Config.MoabPlatform.Environment[environmentCount10].Head = environment10.Head
							r.Launch.ComputeEnv.Config.MoabPlatform.Environment[environmentCount10].Name = environment10.Name
							r.Launch.ComputeEnv.Config.MoabPlatform.Environment[environmentCount10].Value = environment10.Value
						}
					}
				...
				if resp.Launch.ComputeEnv.Config.SeqeraComputeConfiguration != nil {
					...
					for environmentCount11, environmentItem11 := range resp.Launch.ComputeEnv.Config.SeqeraComputeConfiguration.Environment {
						...
						if environmentCount11+1 > len(r.Launch.ComputeEnv.Config.SeqeracomputePlatform.Environment) {
							...
							r.Launch.ComputeEnv.Config.SeqeracomputePlatform.Environment[environmentCount11].Compute = environment11.Compute
							r.Launch.ComputeEnv.Config.SeqeracomputePlatform.Environment[environmentCount11].Head = environment11.Head
							r.Launch.ComputeEnv.Config.SeqeracomputePlatform.Environment[environmentCount11].Name = environment11.Name
							r.Launch.ComputeEnv.Config.SeqeracomputePlatform.Environment[environmentCount11].Value = environment11.Value
						}
					}
				...
				if resp.Launch.ComputeEnv.Config.SlurmConfiguration != nil {
					...
					for environmentCount12, environmentItem12 := range resp.Launch.ComputeEnv.Config.SlurmConfiguration.Environment {
						...
						if environmentCount12+1 > len(r.Launch.ComputeEnv.Config.SlurmPlatform.Environment) {
							...
							r.Launch.ComputeEnv.Config.SlurmPlatform.Environment[environmentCount12].Compute = environment12.Compute
							r.Launch.ComputeEnv.Config.SlurmPlatform.Environment[environmentCount12].Head = environment12.Head
							r.Launch.ComputeEnv.Config.SlurmPlatform.Environment[environmentCount12].Name = environment12.Name
							r.Launch.ComputeEnv.Config.SlurmPlatform.Environment[environmentCount12].Value = environment12.Value
						}
					}
				...
				if resp.Launch.ComputeEnv.Config.UnivaGridEngineConfiguration != nil {
					...
					for environmentCount13, environmentItem13 := range resp.Launch.ComputeEnv.Config.UnivaGridEngineConfiguration.Environment {
						...
						if environmentCount13+1 > len(r.Launch.ComputeEnv.Config.UgePlatform.Environment) {
							...
							r.Launch.ComputeEnv.Config.UgePlatform.Environment[environmentCount13].Compute = environment13.Compute
							r.Launch.ComputeEnv.Config.UgePlatform.Environment[environmentCount13].Head = environment13.Head
							r.Launch.ComputeEnv.Config.UgePlatform.Environment[environmentCount13].Name = environment13.Name
							r.Launch.ComputeEnv.Config.UgePlatform.Environment[environmentCount13].Value = environment13.Value
						}
					}
