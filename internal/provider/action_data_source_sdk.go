		...
		if resp.Launch == nil {
			...
			if resp.Launch.ComputeEnv == nil {
				...
				if resp.Launch.ComputeEnv.Config.AzureCloudConfiguration != nil {
					r.Launch.ComputeEnv.Config.AzureCloudConfiguration = &tfTypes.AzureCloudConfiguration{}
					r.Launch.ComputeEnv.Config.AzureCloudConfiguration.DataCollectionEndpoint = types.StringPointerValue(resp.Launch.ComputeEnv.Config.AzureCloudConfiguration.DataCollectionEndpoint)
					r.Launch.ComputeEnv.Config.AzureCloudConfiguration.DataCollectionRuleID = types.StringPointerValue(resp.Launch.ComputeEnv.Config.AzureCloudConfiguration.DataCollectionRuleID)
					r.Launch.ComputeEnv.Config.AzureCloudConfiguration.Environment = []tfTypes.ConfigEnvVariable{}

					for _, environmentItem5 := range resp.Launch.ComputeEnv.Config.AzureCloudConfiguration.Environment {
						...
						r.Launch.ComputeEnv.Config.AzureCloudConfiguration.Environment = append(r.Launch.ComputeEnv.Config.AzureCloudConfiguration.Environment, environment5)
					}
					r.Launch.ComputeEnv.Config.AzureCloudConfiguration.ForgedResources = []tfTypes.MapEntryStringString{}

					for _, forgedResourcesItem := range resp.Launch.ComputeEnv.Config.AzureCloudConfiguration.ForgedResources {
						...
						r.Launch.ComputeEnv.Config.AzureCloudConfiguration.ForgedResources = append(r.Launch.ComputeEnv.Config.AzureCloudConfiguration.ForgedResources, forgedResources)
					}
					r.Launch.ComputeEnv.Config.AzureCloudConfiguration.Fusion2Enabled = types.BoolPointerValue(resp.Launch.ComputeEnv.Config.AzureCloudConfiguration.Fusion2Enabled)
					r.Launch.ComputeEnv.Config.AzureCloudConfiguration.InstanceType = types.StringPointerValue(resp.Launch.ComputeEnv.Config.AzureCloudConfiguration.InstanceType)
					r.Launch.ComputeEnv.Config.AzureCloudConfiguration.LogTableName = types.StringPointerValue(resp.Launch.ComputeEnv.Config.AzureCloudConfiguration.LogTableName)
					r.Launch.ComputeEnv.Config.AzureCloudConfiguration.LogWorkspaceID = types.StringPointerValue(resp.Launch.ComputeEnv.Config.AzureCloudConfiguration.LogWorkspaceID)
					r.Launch.ComputeEnv.Config.AzureCloudConfiguration.ManagedIdentityClientID = types.StringPointerValue(resp.Launch.ComputeEnv.Config.AzureCloudConfiguration.ManagedIdentityClientID)
					r.Launch.ComputeEnv.Config.AzureCloudConfiguration.ManagedIdentityID = types.StringPointerValue(resp.Launch.ComputeEnv.Config.AzureCloudConfiguration.ManagedIdentityID)
					r.Launch.ComputeEnv.Config.AzureCloudConfiguration.NetworkID = types.StringPointerValue(resp.Launch.ComputeEnv.Config.AzureCloudConfiguration.NetworkID)
					r.Launch.ComputeEnv.Config.AzureCloudConfiguration.NextflowConfig = types.StringPointerValue(resp.Launch.ComputeEnv.Config.AzureCloudConfiguration.NextflowConfig)
					r.Launch.ComputeEnv.Config.AzureCloudConfiguration.PostRunScript = types.StringPointerValue(resp.Launch.ComputeEnv.Config.AzureCloudConfiguration.PostRunScript)
					r.Launch.ComputeEnv.Config.AzureCloudConfiguration.PreRunScript = types.StringPointerValue(resp.Launch.ComputeEnv.Config.AzureCloudConfiguration.PreRunScript)
					r.Launch.ComputeEnv.Config.AzureCloudConfiguration.Region = types.StringPointerValue(resp.Launch.ComputeEnv.Config.AzureCloudConfiguration.Region)
					r.Launch.ComputeEnv.Config.AzureCloudConfiguration.ResourceGroup = types.StringPointerValue(resp.Launch.ComputeEnv.Config.AzureCloudConfiguration.ResourceGroup)
					r.Launch.ComputeEnv.Config.AzureCloudConfiguration.SubscriptionID = types.StringPointerValue(resp.Launch.ComputeEnv.Config.AzureCloudConfiguration.SubscriptionID)
					r.Launch.ComputeEnv.Config.AzureCloudConfiguration.WaveEnabled = types.BoolPointerValue(resp.Launch.ComputeEnv.Config.AzureCloudConfiguration.WaveEnabled)
					r.Launch.ComputeEnv.Config.AzureCloudConfiguration.WorkDir = types.StringPointerValue(resp.Launch.ComputeEnv.Config.AzureCloudConfiguration.WorkDir)
				}
				if resp.Launch.ComputeEnv.Config.GoogleBatchServiceConfiguration != nil {
					...
					for _, environmentItem6 := range resp.Launch.ComputeEnv.Config.GoogleBatchServiceConfiguration.Environment {
						...
						r.Launch.ComputeEnv.Config.GoogleBatch.Environment = append(r.Launch.ComputeEnv.Config.GoogleBatch.Environment, environment6)
					}
				...
				if resp.Launch.ComputeEnv.Config.GoogleCloudConfiguration != nil {
					r.Launch.ComputeEnv.Config.GoogleCloudConfiguration = &tfTypes.GoogleCloudConfiguration{}
					r.Launch.ComputeEnv.Config.GoogleCloudConfiguration.Arm64Enabled = types.BoolPointerValue(resp.Launch.ComputeEnv.Config.GoogleCloudConfiguration.Arm64Enabled)
					r.Launch.ComputeEnv.Config.GoogleCloudConfiguration.BootDiskSizeGb = types.Int32PointerValue(typeconvert.IntPointerToInt32Pointer(resp.Launch.ComputeEnv.Config.GoogleCloudConfiguration.BootDiskSizeGb))
					r.Launch.ComputeEnv.Config.GoogleCloudConfiguration.Environment = []tfTypes.ConfigEnvVariable{}

					for _, environmentItem7 := range resp.Launch.ComputeEnv.Config.GoogleCloudConfiguration.Environment {
						...
						r.Launch.ComputeEnv.Config.GoogleCloudConfiguration.Environment = append(r.Launch.ComputeEnv.Config.GoogleCloudConfiguration.Environment, environment7)
					}
					r.Launch.ComputeEnv.Config.GoogleCloudConfiguration.ForgedResources = nil
					for _, forgedResourcesItem1 := range resp.Launch.ComputeEnv.Config.GoogleCloudConfiguration.ForgedResources {
						...
						r.Launch.ComputeEnv.Config.GoogleCloudConfiguration.ForgedResources = append(r.Launch.ComputeEnv.Config.GoogleCloudConfiguration.ForgedResources, forgedResources1)
					}
					r.Launch.ComputeEnv.Config.GoogleCloudConfiguration.Fusion2Enabled = types.BoolPointerValue(resp.Launch.ComputeEnv.Config.GoogleCloudConfiguration.Fusion2Enabled)
					r.Launch.ComputeEnv.Config.GoogleCloudConfiguration.GpuEnabled = types.BoolPointerValue(resp.Launch.ComputeEnv.Config.GoogleCloudConfiguration.GpuEnabled)
					r.Launch.ComputeEnv.Config.GoogleCloudConfiguration.ImageID = types.StringPointerValue(resp.Launch.ComputeEnv.Config.GoogleCloudConfiguration.ImageID)
					r.Launch.ComputeEnv.Config.GoogleCloudConfiguration.InstanceType = types.StringPointerValue(resp.Launch.ComputeEnv.Config.GoogleCloudConfiguration.InstanceType)
					r.Launch.ComputeEnv.Config.GoogleCloudConfiguration.NextflowConfig = types.StringPointerValue(resp.Launch.ComputeEnv.Config.GoogleCloudConfiguration.NextflowConfig)
					r.Launch.ComputeEnv.Config.GoogleCloudConfiguration.PostRunScript = types.StringPointerValue(resp.Launch.ComputeEnv.Config.GoogleCloudConfiguration.PostRunScript)
					r.Launch.ComputeEnv.Config.GoogleCloudConfiguration.PreRunScript = types.StringPointerValue(resp.Launch.ComputeEnv.Config.GoogleCloudConfiguration.PreRunScript)
					r.Launch.ComputeEnv.Config.GoogleCloudConfiguration.ProjectID = types.StringPointerValue(resp.Launch.ComputeEnv.Config.GoogleCloudConfiguration.ProjectID)
					r.Launch.ComputeEnv.Config.GoogleCloudConfiguration.Region = types.StringPointerValue(resp.Launch.ComputeEnv.Config.GoogleCloudConfiguration.Region)
					r.Launch.ComputeEnv.Config.GoogleCloudConfiguration.ServiceAccountEmail = types.StringPointerValue(resp.Launch.ComputeEnv.Config.GoogleCloudConfiguration.ServiceAccountEmail)
					r.Launch.ComputeEnv.Config.GoogleCloudConfiguration.WaveEnabled = types.BoolPointerValue(resp.Launch.ComputeEnv.Config.GoogleCloudConfiguration.WaveEnabled)
					r.Launch.ComputeEnv.Config.GoogleCloudConfiguration.WorkDir = types.StringPointerValue(resp.Launch.ComputeEnv.Config.GoogleCloudConfiguration.WorkDir)
					r.Launch.ComputeEnv.Config.GoogleCloudConfiguration.Zone = types.StringPointerValue(resp.Launch.ComputeEnv.Config.GoogleCloudConfiguration.Zone)
				}
				if resp.Launch.ComputeEnv.Config.GoogleGKEClusterConfiguration != nil {
					...
					for _, environmentItem8 := range resp.Launch.ComputeEnv.Config.GoogleGKEClusterConfiguration.Environment {
						...
						r.Launch.ComputeEnv.Config.GkePlatform.Environment = append(r.Launch.ComputeEnv.Config.GkePlatform.Environment, environment8)
					}
				...
				if resp.Launch.ComputeEnv.Config.GoogleLifeSciencesConfiguration != nil {
					...
					for _, environmentItem9 := range resp.Launch.ComputeEnv.Config.GoogleLifeSciencesConfiguration.Environment {
						...
						r.Launch.ComputeEnv.Config.GoogleLifesciences.Environment = append(r.Launch.ComputeEnv.Config.GoogleLifesciences.Environment, environment9)
					}
					...
					if len(resp.Launch.ComputeEnv.Config.GoogleLifeSciencesConfiguration.Labels) > 0 {
						...
						for key2, value2 := range resp.Launch.ComputeEnv.Config.GoogleLifeSciencesConfiguration.Labels {
							r.Launch.ComputeEnv.Config.GoogleLifesciences.Labels[key2] = types.StringValue(value2)
						}
					}
				...
				if resp.Launch.ComputeEnv.Config.IBMLSFConfiguration != nil {
					...
					for _, environmentItem10 := range resp.Launch.ComputeEnv.Config.IBMLSFConfiguration.Environment {
						...
						r.Launch.ComputeEnv.Config.LsfPlatform.Environment = append(r.Launch.ComputeEnv.Config.LsfPlatform.Environment, environment10)
					}
				...
				if resp.Launch.ComputeEnv.Config.KubernetesComputeConfiguration != nil {
					...
					for _, environmentItem11 := range resp.Launch.ComputeEnv.Config.KubernetesComputeConfiguration.Environment {
						...
						r.Launch.ComputeEnv.Config.K8sPlatform.Environment = append(r.Launch.ComputeEnv.Config.K8sPlatform.Environment, environment11)
					}
				...
				if resp.Launch.ComputeEnv.Config.LocalExecutionConfiguration != nil {
					...
					for _, environmentItem12 := range resp.Launch.ComputeEnv.Config.LocalExecutionConfiguration.Environment {
						...
						r.Launch.ComputeEnv.Config.LocalPlatform.Environment = append(r.Launch.ComputeEnv.Config.LocalPlatform.Environment, environment12)
					}
				...
				if resp.Launch.ComputeEnv.Config.SeqeraComputeConfiguration != nil {
					...
					for _, environmentItem14 := range resp.Launch.ComputeEnv.Config.SeqeraComputeConfiguration.Environment {
						...
						r.Launch.ComputeEnv.Config.SeqeracomputePlatform.Environment = append(r.Launch.ComputeEnv.Config.SeqeracomputePlatform.Environment, environment14)
					}
					...
					if resp.Launch.ComputeEnv.Config.SeqeraComputeConfiguration.Forge == nil {
				...
				if resp.Launch.ComputeEnv.Config.SlurmConfiguration != nil {
					...
					for _, environmentItem15 := range resp.Launch.ComputeEnv.Config.SlurmConfiguration.Environment {
						...
						r.Launch.ComputeEnv.Config.SlurmPlatform.Environment = append(r.Launch.ComputeEnv.Config.SlurmPlatform.Environment, environment15)
					}
				...
				if resp.Launch.ComputeEnv.Config.UnivaGridEngineConfiguration != nil {
					...
					for _, environmentItem16 := range resp.Launch.ComputeEnv.Config.UnivaGridEngineConfiguration.Environment {
						...
						r.Launch.ComputeEnv.Config.UgePlatform.Environment = append(r.Launch.ComputeEnv.Config.UgePlatform.Environment, environment16)
					}
